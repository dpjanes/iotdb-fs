...
const _is = (statter, tester, method) => (_self, done) => {
    ...
    _.promise.make(self)
        .then(sd => _.d.add(sd, "exists", false))
        .then(statter)
...
exports.is.file.really = _.promise.denodeify(_is(iotdb_fs.stat.symbolic_link, 
    sd => sd.stats.isFile(), "fs.is.file"));
exports.is.directory = _.promise.denodeify(_is(iotdb_fs.stat, 
    sd => sd.stats.isDirectory(), "fs.is.directory"));
exports.is.directory.really = _.promise.denodeify(_is(iotdb_fs.stat.symbolic_link, 
    sd => sd.stats.isDirectory(), "fs.is.directory"));
